...
<figure>
  ...
  <div id="health-bar"/>
  <div id="health-text"/>
  <div id="inventory-overlay-use" class="inventory-overlay"/>
  <div id="inventory-overlay-drop" class="inventory-overlay"/>
  <div id="messages"/>
...
<x:footer>
  <style>
      ...
      #inventory-overlay-use {
          background: hsl(200, 10%, 20%);
          color: white;
      }
      #inventory-overlay-drop {
      ...
      #inventory-overlay-use kbd {
          background: hsl(150, 50%, 30%);
          color: cyan;
      }
      #inventory-overlay-drop kbd {
