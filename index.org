#+title: 2020 Summer Roguelike project
#+date: <2020-06-18 Thu>
#+options: toc:nil
...
Not mentioned in the ROT.js interactive manual, ROT.js's display class has a useful method =eventToPosition=, documented [[https://ondras.github.io/rot.js/doc/classes/display_display.default.html#eventToPosition][here]]. It takes a mouse event and gives us back a grid tile location. If it returns =[-1, -1]= it was out of range (which seems like it should never happen, but does).
